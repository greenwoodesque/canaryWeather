...
//
//  Slightly adapted by David Greenwood
...
//TODO: Add relationshipKeyPathsForPrefetching parameter to find/fetch routines
...
extension Managed where Self: NSManagedObject {
    ...
    static func findAll(in context: NSManagedObjectContext) -> [Self]? {
        var a = [Self]()
...
func createForecastContainer(completion: @escaping (NSPersistentContainer) -> ()) {
